  ...
  return (
    <div className="app">
      ...
      <TimedReveal revealAfter={5000}>
        <CorruptedText corruptAfter={20000}>
      ...
      <TimedReveal revealAfter={15000}>
        <CorruptedText corruptAfter={30000}>
      ...
      <TimedReveal revealAfter={25000}>
        <CorruptedText corruptAfter={40000}>
      ...
      <TimedReveal revealAfter={35000}>
        <CorruptedText corruptAfter={50000}>
      ...
      <TimedReveal revealAfter={45000}>
        <CorruptedText corruptAfter={60000}>
